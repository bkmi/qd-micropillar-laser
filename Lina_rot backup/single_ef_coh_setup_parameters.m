...
addpath('~/dde_biftool_v3.0/ddebiftool/'); 
addpath('~/dde_biftool_v3.0/ddebiftool_extra_psol/');
addpath('~/dde_biftool_v3.0/ddebiftool_utilities/');
addpath('~/dde_biftool_v3.0/ddebiftool_extra_rotsym');
